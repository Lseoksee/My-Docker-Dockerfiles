...
# BASE_VERSION=24.04, 22.04(CUDA 사용 가능)
# CUDA_VERSION=11.8, 12.1

# CUDA 없이 빌드 
docker buildx build --build-arg "BASE_VERSION=24.04" --platform linux/amd64,linux/arm64 --push -t da864268/conda:ubuntu-24.04 .
